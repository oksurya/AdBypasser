...
st.set_page_config(page_title="URL Bypasser", page_icon='🧊',
                   layout="centered", initial_sidebar_state="auto",    menu_items={
                       'Get Help': 'https://telegram.me/oksurya',
                       'Report a bug': "https://telegram.me/oksurya",
                       'About': "This is URL Bypasser for ADLINKFLY based website. (https://github.com/oksurya)"
                   })
...
st.text('Deployed by Jayasurya Mailsamy')
